import{c as r,o as n,j as e,t,k as o}from"./chunks/framework.aai8Pu2t.js";const a=`<a-config-provider :theme="{ algorithm: isDark ? theme.darkAlgorithm : theme.defaultAlgorithm }">\r
\r
...
\`\`\`vue preview\r
<template>\r
  <Form ref="form" :model="model" :label-col="{ span: 2 }" @finish="onFinish" :items="[\r
    { lp: ['姓名', 'name'] },\r
    ...
    <a-form-item :wrapper-col="{ offset: 2 }">\r
      ...
      <a-button @click="$refs.form.resetFields()">Reset</a-button>\r
    </a-form-item>\r
\r
    <a-form-item :wrapper-col="{ offset: 2 }">\r
...
<\/script>`,s={class:"language-markdown"},d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"raw/ui/antdv.md","filePath":"raw/ui/antdv.md"}'),i={name:"raw/ui/antdv.md"},f=Object.assign(i,{setup(p){return(m,l)=>(n(),r("div",null,[e("pre",s,t(o(a)),1)]))}});export{d as __pageData,f as default};
