import{c as e,o as r,j as t,t as n,k as m}from"./chunks/framework.C9-9fwSE.js";const i=`# 基础使用\r
\r
...
const items = schema2items(model, {\r
  ...
  properties: {\r
    ...
    resume: { title: '简历', type: 'object', 'ui:bodyClass': 'grid cols-2 gap-x-4 items-start', properties: {\r
...
\`\`\`vue preview\r
<template>\r
  <Form ref="form" :model="model" :items="items" @_submit="">\r
    <el-form-item>\r
      <code block><pre>model: {{ JSON.stringify(model, null, '  ') }}</pre></code>\r
    </el-form-item>\r
  </Form>\r
...
import { ref, provide, defineComponent } from 'vue'\r
import Form, { schema2items } from 'el-form-render/element-plus'\r
\r
const model = ref({\r
  tags: ['编程', 'JavaScript', 'Vue'],\r
  posts: [{}, {}]\r
})\r
\r
const opts = { enum: [true, false], enumName: ['true', 'true'] }\r
  ...
  definitions: {\r
    User: {\r
      ...
      properties: {\r
        name: { title: '名称', type: 'string' },\r
        email: { title: '邮件', type: 'string' },\r
        tags: { title: '标签', type: 'array', items: { type: 'string' }, 'ui:type': 'input-tag' },\r
        posts: { title: '文章列表', type: 'array', items: { $ref: '#/definitions/Post' } },\r
      }\r
    },\r
    Post: {\r
      type: 'object',\r
      properties: {\r
        title: { title: '标题', type: 'string' },\r
        content: { title: '内容', type: 'string' },\r
        date: { title: '日期', type: 'string' },\r
      }\r
    },\r
  },\r
...
<\/script>\r
\`\`\``,s={class:"language-markdown"},c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"raw/jsf/basic.md","filePath":"raw/jsf/basic.md"}'),o={name:"raw/jsf/basic.md"},f=Object.assign(o,{setup(p){return(l,a)=>(r(),e("div",null,[t("pre",s,n(m(i)),1)]))}});export{c as __pageData,f as default};
