...
`),O("span",{class:"line"},[O("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),O("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),O("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:Ae(()=>[m(Oh)]),_:1}),t[2]||(t[2]=bo('<h2 id="results" tabindex="-1">Results <a class="header-anchor" href="#results" aria-label="Permalink to &quot;Results&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p><code>lp</code> 是 <code>label prop</code> 的缩写</p><p>如果不指定 <code>type</code> 则默认为 <code>input</code></p></div>',2)),(Ai(),Il(Ge("style"),null,{default:Ae(()=>[bn($t(lt(Rd)),1)]),_:1})),t[3]||(t[3]=O("link",{rel:"stylesheet",href:"https://cdn.jsdelivr.net/npm/@mdi/font@latest/css/materialdesignicons.min.css"},null,-1))]))}});export{a0 as __pageData,i0 as default};
