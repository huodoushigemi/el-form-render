import{c as e,o as r,j as n,t,k as o}from"./chunks/framework.aai8Pu2t.js";const l=`# element-plus 表单渲染\r
\r
...
\`\`\`vue preview\r
<template>\r
  <Form ref="form" :model="model" label-width="60px" @submit.prevent="onSubmit" :items="[\r
    { lp: ['姓名', 'name'] },\r
...
:::\r
`,m={class:"language-markdown"},c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"raw/ui/element-plus.md","filePath":"raw/ui/element-plus.md"}'),s={name:"raw/ui/element-plus.md"},f=Object.assign(s,{setup(p){return(i,a)=>(r(),e("div",null,[n("pre",m,t(o(l)),1)]))}});export{c as __pageData,f as default};
