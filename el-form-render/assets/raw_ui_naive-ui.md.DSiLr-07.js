import{c as r,o as e,j as n,t,k as a}from"./chunks/framework.C9-9fwSE.js";const o=`<n-config-provider :theme="isDark ? darkTheme : undefined">\r
\r
# naive-ui 表单渲染\r
\r
...
\`\`\`vue preview\r
<template>\r
  <Form :model="model" label-placement="left" label-width="auto" @_submit="onSubmit" :items="[\r
    { lp: ['姓名', 'name'] },\r
    ...
    <n-form-item label=' '>\r
      <n-button type="primary" attr-type="submit">Submit</n-button>\r
      <n-button class="ml-3" attr-type="reset">Reset</n-button>\r
    </n-form-item>\r
\r
    <n-form-item label=' '>\r
...
<\/script>`,i={class:"language-markdown"},c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"raw/ui/naive-ui.md","filePath":"raw/ui/naive-ui.md"}'),s={name:"raw/ui/naive-ui.md"},d=Object.assign(s,{setup(p){return(m,l)=>(e(),r("div",null,[n("pre",i,t(a(o)),1)]))}});export{c as __pageData,d as default};
