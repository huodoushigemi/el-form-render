import{c as r,o as n,j as e,t,k as a}from"./chunks/framework.C9-9fwSE.js";const o=`<van-config-provider :theme="isDark ? 'dark' : ''">\r
\r
# vant 表单渲染\r
\r
...
\`\`\`vue preview\r
<template>\r
  <Form class="max-w[350px] bg-#909090 p1" :model="model" @_submit="onSubmit" :items="[\r
...
<\/script>`,s={class:"language-markdown"},u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"raw/ui/vant.md","filePath":"raw/ui/vant.md"}'),p={name:"raw/ui/vant.md"},d=Object.assign(p,{setup(i){return(l,c)=>(n(),r("div",null,[e("pre",s,t(a(o)),1)]))}});export{u as __pageData,d as default};
